...
<head>
    ...
    <link rel="stylesheet" href="/projects/acouguedofiel/css/caixa.css">
    <link rel="stylesheet" href="/projects/acouguedofiel/css/modal.css">
</head>
<body>
    <div id='printable'>
    ...
    <section>
        ...
        <div class="ajuste-modal" id="modal-dinheiro">
            <div class="modal">
                <form action="php/pagamento.php" id='form_pagamento'>
                    <a onclick = " tiramodal() "><img src="/projects/acouguedofiel/img/delete2.png" alt=""></a>
        ...
        <div class="ajuste-modal" id="modal-deleta">
            <div class="modal">
                <form id='form_deleta'>
                    <a onclick = " tiramodal2() "><img src="/projects/acouguedofiel/img/delete2.png" alt=""></a>
...
<script src='/projects/acouguedofiel/js/caixa.js'></script>