...
<head>
    ...
    <link rel="stylesheet" href="/projects/lamolienda/css/geral.css">
    <link rel="stylesheet" href="/projects/lamolienda/css/contact.css">
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-1BmE4kWBq78iYhFldvKuhfTAU6auU8tT94WrHftjDbrCEXSU1oBoqyl2QvZ6jIW3" crossorigin="anonymous">
    <title>La Molienda</title>
    <link rel="shortcut icon" href="/projects/lamolienda/img/main-logo.png" />
</head>
<body>
    <nav class="navbar navbar-expand-lg navbar-light">
        <div class="container-fluid">
          <a class="navbar-brand" href="/projects/lamolienda/index.html"><img src="/projects/lamolienda/img/logo.png" alt="" class="logo"></a>
          ...
          <div class="collapse navbar-collapse pages" id="navbarNav">
            <ul class="navbar-nav">
              <li class="nav-item">
                <a class="nav-link" aria-current="page" href="/projects/lamolienda/index.html">Home</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" aria-current="page" href="/projects/lamolienda/nosotros.html">Nosotros</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="/projects/lamolienda/productos.html">Productos</a>
              </li>
              <li class="nav-item contacto">
                <a class="nav-link" href="/projects/lamolienda/contacto.php">Contacto</a>
              </li>
            </ul>
          </div>
          <img src="/projects/lamolienda/img/logo.png" style="opacity:0;" alt="" class="logo logo2">
        </div>
    </nav>
    ...
    <footer class="footer">
        <div class="footer-container">
            ...
            <div class="social-media">
                <img src="/projects/lamolienda/img/instagram.png" onclick="insta()" alt="">
                <img src="/projects/lamolienda/img/facebook.png" onclick="face()" alt="">
                <img src="/projects/lamolienda/img/whatsapp.png" onclick="wpp()" alt="">
            </div>  
        </div>
        <hr>
  ...
  <script src="/projects/lamolienda/js/jquery.js"></script>
  <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-ka7Sk0Gln4gmtz2MlQnikT1wXgYsOg+OMhuP+IlRH9sENBO0LRn5q+8nbTov4+1p" crossorigin="anonymous"></script>
  <script src="/projects/lamolienda/js/main.js"></script>
</html>